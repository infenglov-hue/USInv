...
| Alpha Vantage listing status | P | https://www.alphavantage.co/documentation/ | `LISTING_STATUS` accepts a date after 2010-01-01 and returns active/delisted US stocks/ETFs as CSV; the public 2014-07-10 delisted demo was schema/date-validated, while the matching active demo returned `{}` | 2026-07-18 | Phase 0.4 with a personal key, then hash every permitted CSV |
