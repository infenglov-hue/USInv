...
| Tiingo EOD schema | P | https://www.tiingo.com/documentation/end-of-day | EOD rows expose raw+adjusted OHLCV, `divCash` whose row date is the ex-date, and `splitFactor`; the current free plan displays 50 hourly and 1,000 daily requests. USInv caps itself at 50/hour and uses Tiingo only for detector-flagged spot checks. Live token entitlement remains to be verified. | 2026-07-20 | On schema/plan change and before Phase 2.2 approval |
