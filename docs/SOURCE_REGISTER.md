...
| Alpaca corporate actions | P | https://docs.alpaca.markets/us/reference/corporateactions-1 | Current `GET /v1/corporate-actions` is paginated and exposes declared split/dividend/merger/spin-off categories; provider warns that action creation may be delayed. Basic-tier entitlement remains an empirical Phase 2.1 check and is not inferred from the public schema | 2026-07-19 | Complete day-one credentialed probe; then quarterly |
