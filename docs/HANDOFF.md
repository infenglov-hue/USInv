...
## Active state (2026-09-05)

|| Item | Value |
||---|---|
|| Branch / latest functional code | `main` / `f96c3e1` + unstaged measurement artifacts |
|| Latest functional commit | `f96c3e1` (FSDS NUM orphan quarantine) |
|| Remote relation | Local branch is 9 commits ahead of `origin/main`; nothing pushed |
|| Verification | `ruff check .` passes; full suite **601 passed** |
